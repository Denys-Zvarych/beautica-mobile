...
class _$SalonResponse extends SalonResponse {
  ...
  @override
  SalonResponseBuilder toBuilder() => SalonResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SalonResponse &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SalonResponse')
          ..add('id', id)
          ..add('ownerId', ownerId)
          ..add('name', name)
...
class SalonResponseBuilder
    implements Builder<SalonResponse, SalonResponseBuilder> {
  _$SalonResponse? _$v;
  ...
  SalonResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _ownerId = $v.ownerId;
  ...
  @override
  void replace(SalonResponse other) {
    _$v = other as _$SalonResponse;
  }

  @override
  void update(void Function(SalonResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SalonResponse build() => _build();

  _$SalonResponse _build() {
    final _$result = _$v ??
        _$SalonResponse._(
          id: id,
          ownerId: ownerId,
