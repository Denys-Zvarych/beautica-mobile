...
/// * [bookingId]
@BuiltValue()
abstract class MyReviewResponse
    implements Built<MyReviewResponse, MyReviewResponseBuilder> {
  ...
  factory MyReviewResponse([void updates(MyReviewResponseBuilder b)]) =
      _$MyReviewResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MyReviewResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MyReviewResponse> get serializer =>
      _$MyReviewResponseSerializer();
}

class _$MyReviewResponseSerializer
    implements PrimitiveSerializer<MyReviewResponse> {
  @override
  final Iterable<Type> types = const [MyReviewResponse, _$MyReviewResponse];

  @override
  final String wireName = r'MyReviewResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MyReviewResponse object, {
  ...
  void _deserializeProperties(
    ...
    required MyReviewResponseBuilder result,
  ...
  @override
  MyReviewResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MyReviewResponseBuilder();
