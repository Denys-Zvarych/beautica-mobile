...
abstract class SalonResponse
  ...
  factory SalonResponse([void updates(SalonResponseBuilder b)]) =
      _$SalonResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SalonResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SalonResponse> get serializer =>
      _$SalonResponseSerializer();
}

class _$SalonResponseSerializer implements PrimitiveSerializer<SalonResponse> {
  @override
  final Iterable<Type> types = const [SalonResponse, _$SalonResponse];

  @override
  final String wireName = r'SalonResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SalonResponse object, {
  ...
  void _deserializeProperties(
    ...
    required SalonResponseBuilder result,
  ...
  @override
  SalonResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SalonResponseBuilder();
