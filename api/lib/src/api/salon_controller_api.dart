...
class SalonControllerApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseSalonResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseSalonResponse>> createSalon({
    required CreateSalonRequest createSalonRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateSalonRequest);
      _bodyData =
          _serializers.serialize(createSalonRequest, specifiedType: _type);
    ...
    ApiResponseSalonResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponseSalonResponse),
            ) as ApiResponseSalonResponse;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<ApiResponseSalonResponse>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deactivateSalon({
    required String salonId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/salons/{salonId}'.replaceAll(
        '{' r'salonId' '}',
        encodeQueryParameter(_serializers, salonId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseListBookableMasterResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseListBookableMasterResponse>> getBookableMasters({
    required String salonId,
    ...
    final _path = r'/api/v1/salons/{salonId}/services/{serviceDefId}/masters'
        .replaceAll(
            '{' r'salonId' '}',
            encodeQueryParameter(_serializers, salonId, const FullType(String))
                .toString())
    ...
    ApiResponseListBookableMasterResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiResponseListBookableMasterResponse),
            ) as ApiResponseListBookableMasterResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponseListBookableMasterResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ApiResponsePageResponseMasterSummaryResponse>>
    ...
    final _path = r'/api/v1/salons/{salonId}/masters'.replaceAll(
        '{' r'salonId' '}',
        encodeQueryParameter(_serializers, salonId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseListSalonResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseListSalonResponse>> getOwnedSalons({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/salons/mine';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ApiResponseListSalonResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponseListSalonResponse),
            ) as ApiResponseListSalonResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponseListSalonResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponsePublicSalonResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponsePublicSalonResponse>> getSalon({
    required String salonId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    ApiResponsePublicSalonResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponsePublicSalonResponse),
            ) as ApiResponsePublicSalonResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponsePublicSalonResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseInviteResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseInviteResponse>> inviteMaster({
    required String salonId,
    ...
    final _path = r'/api/v1/salons/{salonId}/invite'.replaceAll(
        '{' r'salonId' '}',
        encodeQueryParameter(_serializers, salonId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    ApiResponseInviteResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponseInviteResponse),
            ) as ApiResponseInviteResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> removeAdmin({
    required String salonId,
    ...
    final _path = r'/api/v1/salons/{salonId}/admins/{userId}'
        .replaceAll(
            '{' r'salonId' '}',
            encodeQueryParameter(_serializers, salonId, const FullType(String))
                .toString())
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseSalonAdminResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseSalonAdminResponse>> rotateAdmin({
    required String salonId,
    required String userId,
    required RotateAdminRequest rotateAdminRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/salons/{salonId}/admins/{userId}/salon'
        .replaceAll(
            '{' r'salonId' '}',
            encodeQueryParameter(_serializers, salonId, const FullType(String))
                .toString())
    ...
    try {
      const _type = FullType(RotateAdminRequest);
      _bodyData =
          _serializers.serialize(rotateAdminRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    ApiResponseSalonAdminResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponseSalonAdminResponse),
            ) as ApiResponseSalonAdminResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponseSalonAdminResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseSalonResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseSalonResponse>> updateSalon({
    required String salonId,
    required UpdateSalonRequest updateSalonRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateSalonRequest);
      _bodyData =
          _serializers.serialize(updateSalonRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
