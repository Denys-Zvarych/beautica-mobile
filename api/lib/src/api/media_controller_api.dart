...
class MediaControllerApi {
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deletePortfolioPhoto({
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponsePageMediaFileResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponsePageMediaFileResponse>> getMasterPortfolio({
    ...
    ApiResponsePageMediaFileResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponsePageMediaFileResponse),
            ) as ApiResponsePageMediaFileResponse;
    ...
    return Response<ApiResponsePageMediaFileResponse>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponsePageMediaFileResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponsePageMediaFileResponse>> getSalonPortfolio({
  ...
  Future<Response<ApiResponseAvatarResponse>> uploadAvatar({
    ...
    ApiResponseAvatarResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponseAvatarResponse),
            ) as ApiResponseAvatarResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponseAvatarResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ApiResponseMediaFileResponse>> uploadPortfolioPhoto({
    ...
    ApiResponseMediaFileResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponseMediaFileResponse),
            ) as ApiResponseMediaFileResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponseMediaFileResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
