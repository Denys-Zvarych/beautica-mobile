...
class AppointmentControllerApi {
  ...
  const AppointmentControllerApi(this._dio, this._serializers);
  ...
  Future<Response<void>> cancelAppointment({
    ...
    final _path = r'/api/v1/appointments/{appointmentId}/cancel'.replaceAll(
        '{' r'appointmentId' '}',
    ...
    try {
      const _type = FullType(AppointmentCancelRequest);
      _bodyData = appointmentCancelRequest == null
          ? null
          : _serializers.serialize(appointmentCancelRequest,
              specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> cancelAppointmentItem({
    required String appointmentId,
    ...
    final _path =
        r'/api/v1/appointments/{appointmentId}/services/{bookingId}/cancel'
            .replaceAll(
                '{' r'appointmentId' '}',
                encodeQueryParameter(
                        _serializers, appointmentId, const FullType(String))
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(cancelBookingRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> completeAppointment({
    required String appointmentId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/appointments/{appointmentId}/complete'.replaceAll(
        '{' r'appointmentId' '}',
        encodeQueryParameter(
                _serializers, appointmentId, const FullType(String))
            .toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseAppointmentDetailResponse>> createAppointment({
    required CreateAppointmentRequest createAppointmentRequest,
    ...
    final _path = r'/api/v1/appointments';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
    ...
    try {
      ...
      _bodyData = _serializers.serialize(createAppointmentRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> declineAppointment({
    required String appointmentId,
    ...
    final _path = r'/api/v1/appointments/{appointmentId}/decline'.replaceAll(
        '{' r'appointmentId' '}',
        encodeQueryParameter(
                _serializers, appointmentId, const FullType(String))
            .toString());
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseAppointmentDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseAppointmentDetailResponse>> getAppointment({
    required String appointmentId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/appointments/{appointmentId}'.replaceAll(
        '{' r'appointmentId' '}',
        encodeQueryParameter(
                _serializers, appointmentId, const FullType(String))
            .toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> notCompleteAppointment({
    required String appointmentId,
    AppointmentProviderNoteRequest? appointmentProviderNoteRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/appointments/{appointmentId}/not-complete'
        .replaceAll(
            '{' r'appointmentId' '}',
            encodeQueryParameter(
                    _serializers, appointmentId, const FullType(String))
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseAppointmentDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseAppointmentDetailResponse>> rescheduleAppointment({
    required String appointmentId,
    required AppointmentRescheduleRequest appointmentRescheduleRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/appointments/{appointmentId}/reschedule'.replaceAll(
        '{' r'appointmentId' '}',
        encodeQueryParameter(
                _serializers, appointmentId, const FullType(String))
            .toString());
    ...
    try {
      const _type = FullType(AppointmentRescheduleRequest);
      _bodyData = _serializers.serialize(appointmentRescheduleRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseAppointmentDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseAppointmentDetailResponse>>
      rescheduleAppointmentItem({
    required String appointmentId,
    required String bookingId,
    required AppointmentItemRescheduleRequest appointmentItemRescheduleRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path =
        r'/api/v1/appointments/{appointmentId}/services/{bookingId}/reschedule'
            .replaceAll(
                '{' r'appointmentId' '}',
                encodeQueryParameter(
                        _serializers, appointmentId, const FullType(String))
    ...
    try {
      const _type = FullType(AppointmentItemRescheduleRequest);
      _bodyData = _serializers.serialize(appointmentItemRescheduleRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
