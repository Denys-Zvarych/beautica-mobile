...
class ServiceControllerApi {
  ...
  const ServiceControllerApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseMasterServiceResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseMasterServiceResponse>>
      addIndependentMasterService({
    required CreateServiceDefinitionRequest createServiceDefinitionRequest,
    ...
    try {
      const _type = FullType(CreateServiceDefinitionRequest);
      _bodyData = _serializers.serialize(createServiceDefinitionRequest,
          specifiedType: _type);
    ...
    ApiResponseMasterServiceResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponseMasterServiceResponse),
            ) as ApiResponseMasterServiceResponse;
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseServiceDefinitionResponse>> addServiceToSalon({
    ...
    ApiResponseServiceDefinitionResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiResponseServiceDefinitionResponse),
            ) as ApiResponseServiceDefinitionResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Parameters:
  /// * [salonId]
  /// * [masterId] - Master row id (NOT a user id)
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseMasterServiceResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseMasterServiceResponse>> assignServiceToMaster({
    required String salonId,
    required String masterId,
    required AssignServiceToMasterRequest assignServiceToMasterRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AssignServiceToMasterRequest);
      _bodyData = _serializers.serialize(assignServiceToMasterRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deactivateServiceDefinition({
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseListMasterServiceResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseListMasterServiceResponse>> getMasterServices({
    required String masterId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseSalonServiceCatalogResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseSalonServiceCatalogResponse>>
    ...
    ApiResponseSalonServiceCatalogResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiResponseSalonServiceCatalogResponse),
            ) as ApiResponseSalonServiceCatalogResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponseSalonServiceCatalogResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> unassignServiceFromMaster({
    required String salonId,
    required String masterId,
    required String serviceDefId,
    CancelToken? cancelToken,
    ...
    final _path =
        r'/api/v1/salons/{salonId}/masters/{masterId}/services/{serviceDefId}'
            .replaceAll(
                '{' r'salonId' '}',
                encodeQueryParameter(
                        _serializers, salonId, const FullType(String))
                    .toString())
            .replaceAll(
                '{' r'masterId' '}',
                encodeQueryParameter(
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseMasterServiceResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseMasterServiceResponse>> updateMasterServiceBand({
    required String salonId,
    required String masterId,
    required String serviceDefId,
    required UpdateMasterServiceBandRequest updateMasterServiceBandRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateMasterServiceBandRequest);
      _bodyData = _serializers.serialize(updateMasterServiceBandRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseServiceDefinitionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseServiceDefinitionResponse>>
      updateServiceDefinition({
    required String serviceDefId,
    required UpdateServiceDefinitionRequest updateServiceDefinitionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateServiceDefinitionRequest);
      _bodyData = _serializers.serialize(updateServiceDefinitionRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
