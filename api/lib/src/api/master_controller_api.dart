...
class MasterControllerApi {
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseVoid] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseVoid>> deactivateMaster({
    required String masterId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/masters/{masterId}'.replaceAll(
        '{' r'masterId' '}',
        encodeQueryParameter(_serializers, masterId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseAvailableSlotsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseAvailableSlotsResponse>> getAvailableSlots({
    ...
    final _path = r'/api/v1/masters/{masterId}/slots'.replaceAll(
        '{' r'masterId' '}',
        encodeQueryParameter(_serializers, masterId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    ApiResponseAvailableSlotsResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponseAvailableSlotsResponse),
            ) as ApiResponseAvailableSlotsResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponsePageResponseBookingResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponsePageResponseBookingResponse>> getMasterCalendar({
    required Date from,
    required Date to,
    ...
    final _path = r'/api/v1/masters/me/calendar';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ApiResponsePageResponseBookingResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiResponsePageResponseBookingResponse),
            ) as ApiResponsePageResponseBookingResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponsePageResponseBookingResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseMasterDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseMasterDetailResponse>> getMasterDetail({
    required String masterId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    ApiResponseMasterDetailResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiResponseMasterDetailResponse),
            ) as ApiResponseMasterDetailResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponsePageResponseMasterSummaryResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponsePageResponseMasterSummaryResponse>>
      getMastersBySalon1({
    ...
    final _path = r'/api/v1/masters/by-salon/{salonId}'.replaceAll(
        '{' r'salonId' '}',
    ...
    ApiResponsePageResponseMasterSummaryResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as ApiResponsePageResponseMasterSummaryResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponsePageResponseMasterSummaryResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseMasterDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseMasterDetailResponse>> getMyProfile({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/masters/me';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseListMasterWorkingDayResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseListMasterWorkingDayResponse>> getWorkingDays({
    required String masterId,
    required Date from,
    required Date to,
    ...
    final _path = r'/api/v1/masters/{masterId}/working-days'.replaceAll(
        '{' r'masterId' '}',
        encodeQueryParameter(_serializers, masterId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    ApiResponseListMasterWorkingDayResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiResponseListMasterWorkingDayResponse),
            ) as ApiResponseListMasterWorkingDayResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseOverrideConflictPreviewResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseOverrideConflictPreviewResponse>>
      previewOverrideConflicts({
    required String masterId,
    required OverrideConflictQueryRequest overrideConflictQueryRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/masters/{masterId}/overrides/conflicts'.replaceAll(
        '{' r'masterId' '}',
        encodeQueryParameter(_serializers, masterId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(OverrideConflictQueryRequest);
      _bodyData = _serializers.serialize(overrideConflictQueryRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    ApiResponseOverrideConflictPreviewResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiResponseOverrideConflictPreviewResponse),
            ) as ApiResponseOverrideConflictPreviewResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponseOverrideConflictPreviewResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseMasterPublicProfileResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseMasterPublicProfileResponse>> updateMyProfile({
    required MasterProfileUpdateRequest masterProfileUpdateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/masters/me/profile';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(MasterProfileUpdateRequest);
      _bodyData = _serializers.serialize(masterProfileUpdateRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    ApiResponseMasterPublicProfileResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiResponseMasterPublicProfileResponse),
            ) as ApiResponseMasterPublicProfileResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponseMasterPublicProfileResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ApiResponseListWorkingHoursResponse>> upsertWorkingHours({
    ...
    final _path = r'/api/v1/masters/{masterId}/working-hours'.replaceAll(
        '{' r'masterId' '}',
        encodeQueryParameter(_serializers, masterId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(BuiltList, [FullType(WorkingHoursRequest)]);
      _bodyData =
          _serializers.serialize(workingHoursRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    ApiResponseListWorkingHoursResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiResponseListWorkingHoursResponse),
            ) as ApiResponseListWorkingHoursResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
