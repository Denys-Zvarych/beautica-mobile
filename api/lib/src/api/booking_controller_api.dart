...
class BookingControllerApi {
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> completeBooking({
    required String bookingId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<ApiResponseBookingDetailResponse>> createBooking({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(createBookingRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> declineBooking({
    required String bookingId,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseBookingDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseBookingDetailResponse>> getBooking({
    required String bookingId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponsePageResponseBookingDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponsePageResponseBookingDetailResponse>>
    ...
    final _path = r'/api/v1/bookings/salon/{salonId}'.replaceAll(
        '{' r'salonId' '}',
    ...
    ApiResponsePageResponseBookingDetailResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as ApiResponsePageResponseBookingDetailResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> notCompleteBooking({
    required String bookingId,
    required StatusUpdateRequest statusUpdateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseBookingDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseBookingDetailResponse>> rescheduleBooking({
    required String bookingId,
    ...
    final _path = r'/api/v1/bookings/{bookingId}/reschedule'.replaceAll(
        '{' r'bookingId' '}',
        encodeQueryParameter(_serializers, bookingId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(RescheduleBookingRequest);
      _bodyData = _serializers.serialize(rescheduleBookingRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
