...
if [[ "${CHECK_MODE}" == "true" ]]; then
  ...
  #   pubspec.yaml          — generator emits static boilerplate (name/version/deps)
  #                           unrelated to spec content; field ordering and
  #                           homepage placeholder differ across generator runs
